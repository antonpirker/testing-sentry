...
LEN = 15
COUNT = 500  # LOTs of items to cache
# COUNT = 100  # Normal amount for this load test.
...
def index(request):
    ...
    for _ in range(10):  # LOTS of items to cache, for the normal load test remove this for. 
